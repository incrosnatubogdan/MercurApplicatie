...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://mercur-e43f8.firebaseio.com/"),
    refCart = new Firebase("https://mercur-e43f8.firebaseio.com/cart"),
    refUser = new Firebase("https://mercur-e43f8.firebaseio.com/users"),
    refCategory = new Firebase("https://mercur-e43f8.firebaseio.com/category"),
    refOrder = new Firebase("https://mercur-e43f8.firebaseio.com/orders"),
    refFeatured = new Firebase("https://mercur-e43f8.firebaseio.com/featured"),
    refMenu = new Firebase("https://mercur-e43f8.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
